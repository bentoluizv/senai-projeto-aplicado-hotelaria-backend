...
class AccommodationDAO:
    ...
    def insert(self, params):
        ...
        cursor = self.db.cursor()
        cursor.execute('INSERT INTO accommodation (uuid, status, name, total_guests, single_beds, double_beds, min_nights, price) VALUES (:uuid, :status, :name, :total_guests, :single_beds, :double_beds, :min_nights, :price;)', params)
        cursor.close()
