...
def db_init(session: Session):
    with open(
        'app/database/sqlalchemy/json/guests.json', encoding='utf-8'
    ) as file:
        data = json.load(file)
    ...
    with open(
        'app/database/sqlalchemy/json/amenities.json', encoding='utf-8'
    ) as file:
        data = json.load(file)
    ...
    with open(
        'app/database/sqlalchemy/json/accommodations.json', encoding='utf-8'
    ) as file:
        data = json.load(file)
    ...
    with open(
        'app/database/sqlalchemy/json/bookings.json', encoding='utf-8'
    ) as file:
        data = json.load(file)
